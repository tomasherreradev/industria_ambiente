        ...
        <div class="card-body">
            <form method="POST" action="{{ route('items.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <select name="metodo" id="metodo" class="form-select select2">
                        ...
                        @foreach($metodos as $met)
                            <option value="{{ trim($met->metodo_codigo) }}" {{ old('metodo')==trim($met->metodo_codigo) ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="precio" id="precio" value="{{ old('precio') }}" step="0.01" min="0" class="form-control @error('precio') is-invalid @enderror" placeholder="Ej: 5000 o 5000.50">
